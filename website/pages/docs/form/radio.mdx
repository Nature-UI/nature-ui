...
You can override the `color` of the Radio to any color key specified in
`theme.colors`.

```jsx
<RadioGroup defaultValue='2'>
  <Stack spacing={12} row>
    <Radio color='red-600' value='1'>
      Radio
    </Radio>
    <Radio color='green-600' value='2'>
      Radio
    </Radio>
  </Stack>
</RadioGroup>
...
```jsx
<Stack spacing={12}>
  <Radio size='sm' name='1' color='red-600'>
    Radio
  </Radio>
  <Radio size='md' name='1' color='green-600'>
    Radio
  </Radio>
  <Radio size='lg' name='1' color='orange-600' defaultChecked>
    Radio
  </Radio>
</Stack>
```
...
function RadioCard(props) {
  ...
  return (
    <Box as='label' className={props.className}>
      <input {...input} />
      <Box
        {...checkbox}
        className={`cursor-pointer border rounded-md shadow-md focus:shadow-outline px-5 py-3 ${
