import { Dict, get, getWithDefault, isObject } from '@nature-ui/utils';

export const hasTheme = (props: PropsOrTheme): props is { theme: Dict } => {
...
export const transformWithConfig = (theme: Dict, value: any, config: any) => {
