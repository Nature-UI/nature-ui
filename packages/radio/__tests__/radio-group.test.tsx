...
describe('@nature-ui/radio', () => {
  ...
  test('setValue action allows setting specific value', () => {
    ...
    fireEvent.click(utils.getByText(/set/iu));
    expect(utils.getByLabelText('a')).toBeChecked();
  });
  ...
  describe('focus action', () => {
    ...
    test('focuses first checked input', () => {
      ...
      fireEvent.click(utils.getByText(/focus/iu));
      expect(document.activeElement).toStrictEqual(utils.getByLabelText('c'));
    });
    ...
    test('focuses first enabled input if none checked', () => {
      ...
      fireEvent.click(utils.getByText(/focus/iu));
      expect(document.activeElement).toStrictEqual(utils.getByLabelText('b'));
    });
  ...
  test('has the proper role', () => {
    ...
    expect(utils.getByRole('radiogroup')).toBeInTheDocument();
  });
});
